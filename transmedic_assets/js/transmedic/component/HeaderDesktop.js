goog.provide('transmedic.component.HeaderDesktop');
 ...
 */
transmedic.component.HeaderDesktop = function(options, element) {

  goog.events.EventTarget.call(this);
  this.options = $.extend({}, transmedic.component.HeaderDesktop.DEFAULT, options);
  ...
  //this.options = $.extend(this.options, transmedic.component.HeaderDesktop.DEFAULT, options);
  ...
  */
  ...
  // console.log('transmedic.component.HeaderDesktop: init');
};
goog.inherits(transmedic.component.HeaderDesktop, goog.events.EventTarget);
 ...
 * @const {object}
 */
transmedic.component.HeaderDesktop.DEFAULT = {
};
...
transmedic.component.HeaderDesktop.prototype.create_search = function(){
...
transmedic.component.HeaderDesktop.prototype.open_search = function() {
...
transmedic.component.HeaderDesktop.prototype.close_search = function() {
...
transmedic.component.HeaderDesktop.prototype.on_document_click = function(event) {
