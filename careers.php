        ...
        <div class="container-fluid has-breakpoint">
            ...
            --><div class="col-md-6 align-col">
              <div class="quote-container">
                ...
                <div class="cta-container">
                  <a href="career-detail.php#fabian" class="read-more-cta">read his story</a>
                </div>
              </div>
            </div>
          </div>
          <div class="row">            
            <div class="col-md-6 align-col align-top hidden-xs hidden-sm">
              ...
              <div class="cta-container">
                <a href="career-detail.php#jeanne" class="read-more-cta">read her story</a>
              </div>
            </div><!--
            --><div class="col-md-6 align-col">
              <div class="text-container">
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  ...
                  <div class="location-tab" id="malaysia-positions">
                    <div class="job-list-item-container">
                  ...
                  <div class="location-tab" id="indonesia-positions">
                    <div class="job-list-item-container">
                  ...
                  <div class="location-tab" id="hongkong-positions">
                    <div class="job-list-item-container">
                  ...
                  <div class="location-tab" id="thailand-positions">
                    <div class="job-list-item-container">
                  ...
                  <div class="location-tab" id="vietnam-positions">
                    <div class="job-list-item-container">
                  ...
                  <div class="location-tab" id="philippines-positions">
                    <div class="job-list-item-container">
