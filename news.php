    ...
    <div id="page-wrapper-content">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    ...
                    <div id="page-news-featured-carousel-container">
                      ...
                      </div> <!-- page-news-featured-carousel -->
      ...
      <article id="page-news-filter-section">
        <div class="container-fluid has-breakpoint">
            ...
            <div id="page-news-filter-list-pin-target-mobile"></div>
            
            <div id="page-news-filter-list-pin-container-mobile">
              <div id="page-news-filter-list-mobile" class="visible-xs visible-sm">                  
                <div class="manic-dropdown">
                  <select name="news_filter" id="news_filter">
                    ...
                    <option value="education">Education And Events</option>
                    <option value="success">Success Stories</option>
                    <option value="life">Life at Transmedic</option>
                  </select>
                </div>
              </div>
            </div>
      ...
      <div class="item-column" data-news-type="all,{{ tag }}">
        ...
        <div class="page-default-news-item">
          <div class="item-title">
            ...
            <h5><a href="{{ link }}" class="hover-sync minimize-text" data-length="70" data-tablet-length="25" data-mobile-length="33">{{ title }}</a></h5>
          </div>                      
