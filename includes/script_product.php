  ...
  <?php if ($is_debug == true): ?>
    ...
    <!-- odometer animation -->
    <script type="text/javascript" src="transmedic_assets/libs/odometer/odometer.min.js"></script>
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "transmedic_assets/js/minified/libraries-product.min.js";
      var PAGE_JS             = "transmedic_assets/js/minified/page-product.min.js";
